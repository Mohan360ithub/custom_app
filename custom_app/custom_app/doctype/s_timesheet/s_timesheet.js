...
frappe.ui.form.on("S Timesheet", {
	...
	make_invoice: function(frm) {
		...
		dialog.set_primary_action(__('Create Sales Invoice'), () => {
			...
			return frappe.call({
				type: "GET",
				method: "custom_app.custom_app.doctype.s_timesheet.s_timesheet.make_sales_invoice",
				args: {
...
frappe.ui.form.on("S Timesheet Detail", {
	...
	activity_type: function (frm, cdt, cdn) {
		...
		frappe.call({
			method: "custom_app.custom_app.doctype.s_timesheet.s_timesheet.get_activity_cost",
			args: {
